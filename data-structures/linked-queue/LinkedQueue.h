// Code based on:
// Data Structures and Algorithms in C++, Goodrich, Tamassia, and Mount, 2nd
// Ed., 2011.
//
#pragma once
...
void LinkedQueue<E>::enqueue(const E& e) {
  D.addBack(e);  // insert after cursor
  n++;
}
...
void LinkedQueue<E>::dequeue() {
  if (empty()) throw length_error("dequeue of empty queue");
  D.removeFront();  // remove from list front
  n--;
}
