...
class Heap
{
  ...
  private:
    ...
    inline bool hasLeftChild(int index) { return getLeftChildIndex(index) < (int)items.size(); }
    inline bool hasRightChild(int index) { return getRightChildIndex(index) < (int)items.size(); }
    ...
    inline int rightChild(int index) { return items.at(getRightChildIndex(index)); }
